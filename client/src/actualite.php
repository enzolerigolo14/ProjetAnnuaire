...
<div class="pdf-container" onclick="event.stopPropagation();">
    <a href="download.php?type=actualite&id=<?= $actualite['id'] ?>&file=<?= basename($actualite['pdf_path']) ?>" class="pdf-link">
        <i class="pdf-icon"></i> Télécharger le PDF
    </a>
</div>
<?php endif; ?>
