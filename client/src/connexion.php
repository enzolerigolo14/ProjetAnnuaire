...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Requête préparée avec le bon nom de colonne (email_professionnel)
        $stmt = $pdo->prepare("
    SELECT id, nom, prenom, mot_de_passe as password
    FROM users 
...
");
        ...
        // Debug: Afficher les données récupérées (à commenter en production)
...
<body>
    <div id="connexion-modal" class="modal">
        <div class="modal-content">
            ...
            <form id="login-form" method="POST" action="connexion.php" novalidate>
